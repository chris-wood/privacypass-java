...
// Import a blind signature.
int brsa_blind_signature_import(const BRSAContext *context, BRSABlindSignature *blind_sig, const uint8_t *encoded_blind_sig,
                               const size_t encoded_blind_sig_len) __attribute__((nonnull));
